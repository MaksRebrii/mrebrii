...
public class Task3 {
    public static void main(String[] args) {
        ...
        System.out.printf("Year: 0\tdeposit: %.2f\taccrued interest: %.2f percents per year%n", (float)(deposit) /1000, percentagePerYear);
        for (int i = 1; i <= amountOfYears; i++) {
            accruedInterest = (int) (deposit * percentagePerYear);
            deposit += accruedInterest;
            System.out.printf("Year: %d\tdeposit: %.2f\taccrued interest: %.2f%n",i, (float)(deposit) /1000, (float)(accruedInterest)/1000);
        }
    }
