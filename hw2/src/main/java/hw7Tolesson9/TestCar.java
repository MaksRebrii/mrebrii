...
public class TestCar {
    ...
    private static void testCar() {
        ...
        System.out.printf("Одесса. В баке сейчас %.0f литров%n", car.getFuelInTank());
        fuelPrice = setFuelPrice(sc);
        car.fillFullTank(fuelPrice);
        car.drive(179, "Кривое Озеро");

        System.out.printf("Остановка Кривое Озеро. В баке сейчас %.0f литров.%n",  car.getFuelInTank());
